...
class TestDeleteOrder :
    ...
    def pre_run_initialization(self):
        self.seller_id = "test_delete_order_{}".format(str(uuid.uuid1()))
        self.store_id = "test_delete_order_{}".format(str(uuid.uuid1()))
        self.buyer_id = "test_delete_order_{}".format(str(uuid.uuid1()))
